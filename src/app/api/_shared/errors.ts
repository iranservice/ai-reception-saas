...
export const API_ERROR_STATUS_MAP: Record<string, number> = {
  ...
  // Validation — CRM
  INVALID_CRM_INPUT: 400,

  // Validation — Conversations
  INVALID_CONVERSATION_INPUT: 400,
  INVALID_MESSAGE_INPUT: 400,
  ...
  CONTACT_METHOD_ALREADY_EXISTS: 409,
  ...
  INVALID_CONVERSATION_TRANSITION: 400,
  CUSTOMER_NOT_IN_BUSINESS: 400,
  ...
  CRM_REPOSITORY_ERROR: 500,
  CONVERSATION_REPOSITORY_ERROR: 500,
